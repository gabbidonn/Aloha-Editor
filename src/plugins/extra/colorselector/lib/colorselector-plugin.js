...
function (Aloha, jQuery, Plugin,Ui,
		Button,
		Floating,
		i18n, i18nCore){
    "use strict";
    ...
    Colorselector.prototype = {
        ...
        return Plugin.create('colorselector', {
            ...
            init: function() {
                ...
                var insertButton = Ui.adopt("colorselector", Button, {
                    click: function(element, event) { self.colorselector.show(element.btnEl.dom, "highlight"); },
                ...
                var insertButtonFC = Ui.adopt("fontcolorselector", Button, {
                    click: function(element, event) { self.colorselector.show(element.btnEl.dom, "color"); },
